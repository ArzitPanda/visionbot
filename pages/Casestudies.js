...
// import AnimatedSlideInComponent from '../animation/AnimatedSlideInComponent'
  ...
  return (
    <div className="bgCaseStudy w-screen">
          ...
          <div className="flex flex-col items-center gap-y-11  w-11/12 md:w-8/12  mx-auto mt-5 mb-10">
            ...
            {Case.map((ele,key)=>{return(
            
            
           
            <div key={key} className="flex flex-col md:flex-row bg-slate-800 md:bg-slate-600 rounded-2xl shadow-2xl shadow-slate-900 items-center">
