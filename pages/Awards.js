...
const Awards = () => {
  ...
  return (
    ...
    <Heading c={'awards'} to="awards" form={'home'}/>
        ...
        {Cert.map((ele,key)=>{return(<div key={key} className="text-yellow-50  h-96 md:h-80  text-base md:text-lg my-7 bg-slate-800 rounded-xl lg:p-4 flex flex-col items-center justify-center">

                <img src={ele.imgLink}  className="self-center flex-shrink-0  w-3/5 h-2/5 md:h-3/5 border object-contain rounded-sm md:justify-self-start shadow-xl "/>
