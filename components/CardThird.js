      ...
      <div className="flex flex-wrap items-center -mx-10">
        <div className="relative w-full lg:w-1/2 px-10 mb-16 lg:mb-0">
          <div className="relative lg:max-w-md lg:ml-auto z-10">
            <img className="object-cover w-full lg:w-112 h-160" src="https://images.pexels.com/photos/7148031/pexels-photo-7148031.jpeg?q=80&amp;fm=jpg&amp;crop=faces&amp;cs=tinysrgb&amp;fit=crop&amp;h=450&amp;w=940" alt=""/>
            ...
            <ul>
              <li className="flex pb-10 mb-8 border-b border-gray-50">
                ...
                <div className="max-w-xs">
                  ...
                  <p className="text-lg">It&rsquo;s over, maecenas tincidunt malesuada dolor sit amet malesuada.</p>
                </div>
              </li>
              <li className="flex pb-10 mb-8 border-b border-gray-50">
                <div className="mr-8">
