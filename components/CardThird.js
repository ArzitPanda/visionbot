  ...
  return (
    ...
    <div class="container px-4 mx-auto">
      <div class="max-w-xl mx-auto mb-16 lg:mb-28 text-center">
        ...
        <h2 class="mt-6 mb-12 text-6xl font-bold font-heading">Build and launch without problems</h2>
        <p class="text-lg text-gray-500">The brown fox jumps over the lazy dog.</p>
      </div>
      <div class="flex flex-wrap items-center -mx-10">
        <div class="relative w-full lg:w-1/2 px-10 mb-16 lg:mb-0">
          <div class="relative lg:max-w-md lg:ml-auto z-10">
            <img class="object-cover w-full lg:w-112 h-160" src="https://images.pexels.com/photos/7148031/pexels-photo-7148031.jpeg?q=80&amp;fm=jpg&amp;crop=faces&amp;cs=tinysrgb&amp;fit=crop&amp;h=450&amp;w=940" alt=""/>
            <div class="absolute bottom-0 left-0 w-full px-12">
              <div class="flex pt-10 pb-16 w-full border-t border-gray-200">
                ...
                <div>
                  <p class="mb-1 text-lg font-bold text-blue-500">Zospace</p>
                  <h4 class="text-4xl font-bold text-white">How it works</h4>
                </div>
              </div>
            </div>
          </div>
        ...
        <div class="w-full lg:w-1/2 px-10">
          <div class="max-w-lg">
            ...
            <div class="mt-10 text-right">
              <a class="inline-block font-bold text-blue-500 hover:text-blue-600" href="#">
